package com.braval.retrofitdemo.views.dialogs;
...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog setTitle(String title) {
        ...
        txt_title.setTextColor(R.color.black);
        return this;
    }
...
//            textView.setBackgroundColor(R.color.white);
            ...
            // 点击事件
            //
//            textView.setTextSize(UZoneUtils.sp2px(context,22));
//            textView.getPaint().setFakeBoldText(true);
    ...
    public enum SheetItemColor {
        Blue("#037BFF"), Red("#FD4A2E"), RateColor("#29b0f4");
        private String name;
