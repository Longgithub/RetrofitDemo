...
/**
 * Created by zhanglong on 2016/10/14.
 */
...
public class MarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mvMaxLength=typedArray.getInt(R.styleable.MarqueeViewStyle_mvMaxLength,-1);
        typedArray.recycle();
    ...
    private TextView createTextView(String text, int position) {
        ...
        tv.setFilters(new InputFilter[]{new InputFilter.LengthFilter(mvMaxLength)});
